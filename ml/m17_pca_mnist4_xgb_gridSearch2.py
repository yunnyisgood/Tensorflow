...
압축 후 DNN:
loss:  0.41474848985671997
accuracy:  0.9453571438789368

Conv1D
loss:  0.18722544610500336
accuracy:  0.9501000046730042

make_pipeline, GridSearchCV PCA(n_components=486)
...
best_params:  {'xgb__n_estimators': 90, 'xgb__max_depth': 6, 'xgb__learning_rate': 0.5, 'xgb__colsample_bytree': 0.9, 'xgb__colsample_bylevel': 0.9}
best_score_:  0.9584107142857142
model.score:  0.9596428571428571
정답률:  0.9596428571428571
'''