...
best_params:  {'rf__max_depth': 3, 'rf__min_samples_leaf': 5}
best_score_:  0.4080714703904006
model.score:  0.5086572414638925
r2 score:  0.5086572414638925

Pipeline, RandomizedSearchCV
최적의 매개변수:  Pipeline(steps=[('scaler', MinMaxScaler()),
                ('rf', RandomForestRegressor(max_depth=3, min_samples_leaf=7))])
best_params:  {'rf__min_samples_leaf': 7, 'rf__max_depth': 3}
best_score_:  0.4149819578623716
model.score:  0.4958328467209938
r2 score:  0.4958328467209938
'''