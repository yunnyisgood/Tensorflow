...
# modeling
# model = Sequential()
# model.add(Dense(100, activation='relu', input_shape=(25, 25)))
...
model = Sequential()
model.add(Dense(units=10, activation='relu', input_shape=(25, 25)))
...
(70000, 25, 25)로 차원 축소 후 cnn
loss:  0.2806852459907532
accuracy:  0.9177142977714539
'''