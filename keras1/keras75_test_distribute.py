...
# strategy = tf.distribute.experimental.CollectiveCommunication.RING
# strategy = tf.distribute.experimental.CollectiveCommunication.NCCL
strategy = tf.distribute.experimental.CollectiveCommunication.AUTO
