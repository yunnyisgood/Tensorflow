...
from tensorflow.keras.layers import Dense, Input, GRU, LSTM, SimpleRNN
...
xx = SimpleRNN(units=32, activation='relu', name='dense0')(input1)
...
xx = SimpleRNN(units=32, activation='relu', name='dense00')(input2)
...
'''
loss:  7.390185356140137
metrics[mae]:  2.692293882369995
'''