...
from tensorflow.keras.layers import Dense, Conv2D, LSTM, Flatten, Conv1D
...
# modeling
model = Sequential()
model.add(LSTM(units=32, activation='relu', input_shape=(10, 1), return_sequences=True))
...
Conv1D로 실행
걸린시간:  23.908076524734497
loss:  [4127.6591796875, 56.23942184448242]
r2 스코어:  0.2415145176298502
'''