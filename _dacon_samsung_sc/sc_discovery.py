...
imgs = ('../_data/samsung_sc_discovery/train_imgs/'+train.uid+'.png').to_numpy()
...
for idx, row in tqdm(test.iterrows()):
    ...
    if m != None:
        img = Draw.MolToImage(m, size=(300,300))
        img.save(f'../_data/samsung_sc_discovery/test_imgs/{file}.png')
        
test_seqs = tokenizer.txt2seq(test.SMILES)
test_imgs = ('../_data/samsung_sc_discovery/test_imgs/'+test.uid+'.png').to_numpy()
...
submission.to_csv('../_data/samsung_sc_discovery/dacon_baseline0817.csv', index=False)
