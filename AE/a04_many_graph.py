...
model_01 = autocoder(hidden_layer_size=1)
model_02 = autocoder(hidden_layer_size=2)
model_04 = autocoder(hidden_layer_size=4)
model_08 = autocoder(hidden_layer_size=8)
model_16 = autocoder(hidden_layer_size=16)
model_32 = autocoder(hidden_layer_size=32)
