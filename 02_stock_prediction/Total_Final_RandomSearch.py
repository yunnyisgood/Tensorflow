...
# modeling
def build_model(drop=0.1, optimizer=Adam, learning_rate=0.00005):
    model = Sequential()
...
def create_hyper_parameter():
    ...
    learning_rate = [0.00005, 0.00008, 0.000001, 0.000005, 0.000008]
...
hist = model.fit(x_train, y_train, verbose=1, epochs=100, validation_split=0.2) 
