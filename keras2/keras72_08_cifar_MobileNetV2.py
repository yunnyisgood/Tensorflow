...
from tensorflow.keras.applications import VGG16, VGG19, ResNet50, ResNet101, InceptionResNetV2, DenseNet121, MobileNetV2
import pandas as pd
...
mob = MobileNetV2(weights='imagenet', include_top=False, input_shape=(32, 32, 3))
