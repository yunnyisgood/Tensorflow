...
model.fit(x_train, y_train, verbose=1, epochs=100, batch_size=256, validation_split=0.2,)#  callbacks=es)
...
둘다 훈련 
loss:  0.6834225058555603
accuracy:  0.7820000052452087
걸린 시간:  86.45133996009827

ES restoring_weight 뺐을 때
