...
# modeling
'''model = Sequential()
model.add(LSTM(units=32, activation='relu', input_shape=(11, 1), return_sequences=True))
...
hist = model.fit(x_train, y_train, epochs=100, batch_size=33, validation_split=0.02,
callbacks=[es, cp])
...
# Conv1d
# loss:  7.960329055786133
# accuracy:  0.2933799922466278

# MCP [전] -> early stopping 지점 <batch_size 8-> 33, epochs 1000 -> 100>
# loss:  10.519790649414062
# accuracy:  0.0011665208730846643

# MCP [후] -> modelCheckPoint 지점 
# loss:  10.877983093261719
# accuracy:  0.0011665208730846643